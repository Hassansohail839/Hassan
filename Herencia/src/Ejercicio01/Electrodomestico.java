...
//Metodo para comprobar colores
	...
	protected static String validateColor(String color) {
		...
		if (colorValidated.equals("blanco") || colorValidated.equals("negro") || colorValidated.equals("rojo")
				|| colorValidated.equals("azul") || colorValidated.equals("gris")) {
...
//Metodo para Comprobar consumo Energetico
	...
	protected char validateConsumoEnergetico(char consumoEnergetico) {
