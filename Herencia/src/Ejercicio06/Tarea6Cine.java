...
// El bucle siguira ejecutandose hasta que el valor de count llegue a 1.
		while (count != 1) {
			System.out.println("Le gustaria comprar una entrada? [Si/No]");
			
// Lee la respuesta del usuario usando objeto sc y guarda en el variable answers.
...
//Reservar el asiento aleatorio en XX
