...
//	        consultarProducto();
	    ...
	    private static void inicializarProductos() {
	        ...
	        stockProductos.put("Gafas", 30);
	        stockProductos.put("Pulsera", 10);
	        stockProductos.put("Ordenador", 10);
	        stockProductos.put("Funda", 130);
	        stockProductos.put("Ratón", 120);
	        stockProductos.put("Soporte", 25);
	        stockProductos.put("Cargador", 30);
	        stockProductos.put("Escritorio", 40);
	        stockProductos.put("Reloj", 80);
	        stockProductos.put("Audífonos", 20);
	    }
